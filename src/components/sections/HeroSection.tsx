  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 md:px-12">
      <div className="max-w-7xl w-full">
        {/* Animated Name */}
        <motion.h1
          className="font-heading font-black text-6xl sm:text-7xl md:text-8xl lg:text-display text-text mb-6 leading-none tracking-tight"
        ...
        <motion.p
          className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-h2 text-gradient-orange mb-8 whitespace-nowrap overflow-visible"
